...
namespace UnityUtils
{
    ...
    public class PlayerPrefsExt : PlayerPrefs
    {
        ...
        public static Int64 GetLong(string key, Int64 defaultValue)
        {
            ...
            Int32 fragA = PlayerPrefs.GetInt(key + "a", defFrag[0]);
            Int32 fragB = PlayerPrefs.GetInt(key + "b", defFrag[1]);
            return (fragA != defFrag[0] && fragB != defFrag[1]) ? IntegerUtil.DoubleInt2Long(fragA, fragB) : defaultValue;
        }
